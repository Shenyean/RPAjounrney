...
async function main() {
    ...
    const browser = await puppeteer.launch({ headless: false, protocolTimeout: 50000, });
  ...
  await page.goto(
    "https://ilearn.learnsaf.gov.sg/curator.html?s=6x2aqh2ZmR2X3MzXzFGcvlWd5RncldXc#modules&project=14&subject=17&module_page=10"
    );
...
await page.waitForSelector(`button[aria-label="${ariaLabel}"][tabindex="${tabIndex}"]`)
